...
export default function BidderOrdersPage() {
    ...
    const paymentCount = orders.filter((o) => o.status === "PAYMENT_SECURED").length;
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardTitle className="text-blue-600 dark:text-blue-400">
                            {ordersQuery.isLoading ? <Skeleton className="h-8 w-12" /> : paymentCount}
                        </CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardTitle className="text-green-600 dark:text-green-400">
                            {ordersQuery.isLoading ? <Skeleton className="h-8 w-12" /> : completedCount}
                        </CardTitle>
                    </CardHeader>
                </Card>
            </div>
                    ...
                    {ordersQuery.isLoading ? (
                        ...
                        <p className="text-sm text-muted-foreground">
                            {statusFilter
                                ...
                                : "Bạn chưa có đơn hàng nào. Thắng phiên đấu giá để tạo đơn hàng!"}
                        </p>
                    ) : (
                        orders.map((order) => (
                            <div
